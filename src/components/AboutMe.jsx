    ...
    <div className="h-screen w-full relative flex flex-col items-center justify-center text-center p-4 overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center gap-8 max-w-2xl">
        <div className="flex flex-col items-center gap-2">
          <h2 className="text-sm font-semibold tracking-widest text-white uppercase">About Me</h2>
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight text-gray-800">Who am I</h1>
        </div>
        ...
        <div className="flex flex-col gap-5 text-left">
          ...
          <p className="text-base md:text-lg text-white leading-relaxed">I focus on writing clean, simple code that lasts. For me, taking the time to build something right is always the fastest approach in the end.</p>
